...
echo.
echo.
set /p choice="[7mChoice [32m[1/2/3/4/5/d][0m "
echo.
...
set /a lines=(%column%/5)*2
mode con: cols=%column% lines=%lines%
echo [7m                                                    [36mSpotify Downloader                                                            [0m
echo.
echo.
set /p spt="[7mEnter url here[0m "
echo.
set /p spe="[7mEnter file format [wav/opus/m4a/ogg/mp3/flac][0m "
echo.
echo [92mProcess - [0m
echo.
spotdl %spt% --use-youtube --output-format %spe% -o "%UserProfile%/downloads"
del "%UserProfile%/downloads/.spotdl-cache"
echo.
echo [32m" Your song downloaded successfully"
del /f "%UserProfile%\Downloads\.spotdl-cache"
echo " If you get any error, follow code & solve your problem."[0m
echo.
echo.
echo [7m opt[35mion[0m 
echo.
echo [a] - Download another song
echo [b] - Go back to main menu
echo [c] - exit
echo.
set /p ch1="[7mChoice [32m[a/b/c][0m "
if /I "[%ch1%]"=="[a]" goto :spotd
if /I "[%ch1%]"=="[b]" goto :main_menu
if /I "[%ch1%]"=="[c]" goto :EOF
::---------------------------------------------------------------------------------------------------------------------------------